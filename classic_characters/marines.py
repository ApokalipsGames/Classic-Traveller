...
# attributes
service = "Marine"
ranks = ["", "Lieutenant", "Captain", "Major", "Lt Colonel", "Colonel", "Brigadier"]
muster_out_benefits = ["Low Psg", "+2 Int", "+1 Edu",
                       "Blade", "Travellers'", "High Psg", "+2 Soc"]
muster_out_cash = [2000, 5000, 5000, 10000, 20000, 30000, 40000]
...
skills = [["Str", "Dex", "End", "Gambling", "Brawling", "Blade Cbt"],  # pdt
          ...
          ["Medical", "Tactics", "Tactics", "Computer", "Leader", "Admin"]]  # ed8+
    ...
    while reup == 'Y':
        ...
        if comm == 'N':
            if commission(upp):
                comm = 'Y'
                rank = 1
                skills_learned.append("Revolver")
                skills_available += 1
