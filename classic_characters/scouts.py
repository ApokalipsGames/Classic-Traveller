...
# attributes
service = "Scout"
muster_out_benefits = ["Low Psg", "+2 Int", "+2 Edu",
                       "Blade", "Gun", "Scout Ship"]
muster_out_cash = [20000, 20000, 30000, 30000, 50000, 50000, 50000]

skills = [["Str", "Dex", "End", "Int", "Edu", "Gun Cbt"],  # pdt
...
def career(name, terms, age, reup, rank, upp):
    skills_learned = ["Pilot"]
    print("Service skill learned: Pilot")
    while reup == 'Y':
        terms += 1
        print("UPP:", upp)
        print("Term:", terms)
...
def muster_out(name, terms, age, rank, upp, sorted_skills):
    ...
    while rolls + cash_rolls < benefits:
        ...
        if ben == 'B':
            ...
            if muster_out_benefits[roll - 1] == "+2 Int":
                upp[3] += 2
                muster_benefits.remove("+2 Int")
