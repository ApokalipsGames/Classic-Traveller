...
def gen_upp():
    ...
    if roll == 12:
        upp.append('X')
    elif roll == 11 or roll == 10:
        upp.append('E')
    elif roll == 9:
        upp.append('D')
    elif roll == 8 or roll == 7:
        upp.append('C')
...
def gen_bases(upp):
    ...
    if roll_dice() + dm >= 7:
        s = True
    if n is True and s is False:
        return 'N'
    elif s is True and n is False:
        return 'S'
    elif s is True and n is True:
        return 'A'
    else:
        return ' '
...
def gen_notes(upp):
    notes = ''
    if 4 <= upp[2] <= 9 and 4 <= upp[3] <= 8 and 5 <= upp[4] <= 7:
        notes += 'Agricultural. '
    ...
    if (upp[2] == 6 or upp[2] == 8) and 6 <= upp[4] <= 8 and 4 <= upp[5] <= 9:
        notes += 'Rich. '
    if (2 >= upp[2] >= 5) and upp[3] <= 3:
        notes += 'Poor. '
    if upp[3] == 10:
        notes += 'Water World. '
